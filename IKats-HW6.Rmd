---
title: "DATA 605 Week 6 Homework"
author: "Ilya Kats"
date: "October 8, 2017"
output:
...
### QUICK ANWERS
#### Full explanations are below.

1. $P(red\ or\ blue) \approx 0.9348$
2. $P(red) =0.25$
3. $P(not\ male\ OR\ do\ not\ live\ with\ parents) \approx 0.8463$
4. Events are DEPENDENT.
5. $211,680$
6. Evenet are INDEPENDENT.
7. $121,080,960$
8. $P(0\ red,\ 1\ orange,\ 3\ green) \approx 0.0459$
9. $7,920$
10. 33% of subscribers to a fitness magazine are 34 years old or younger
11. $E(X)=1.75$. After 559 times, I would expect to win \$978.25.
12. $E(X)=-1.5$. After 994 times, I would expect to loose \$1,491.00.
13.
  a) $P(Liar|Detect^-) \approx 0.596$
  b) $P(Truth\ Teller|Detect^+) \approx 0.8978$
  c) $P(Liar \cup Detect^-) = P(Liar)+P(Detect^-)-P(Liar)\times P(Detect^-|Liar) = 0.28$
