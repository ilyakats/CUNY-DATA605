---
title: "DATA 605 Week 15 Homework"
author: "Ilya Kats"
...
1. $y = -14.8 + 4.257x$
2. $(4,-2,64), (-4, 2, -64)$: Both are saddle points.
3. $R(x,y)=81x+40y+28xy-21x^2-23y^2$ and $R(2.3, 4.1)=116.62$
4. $x=75$, $y=21$
5. $\frac{1}{24}(e^{44} - e^{38} - e^{28} + e^{22})$
