...
Per problem 10, the density of minimum value among $n$ independent random variables with an exponential density has mean $\mu/n$, where $\mu$ is mean of exponential density of individual variable. Per problem, $n=100$ and $\mu=1000$, so the expected time for the first of the bulbs to burn out is $E(M)=\mu/n=1000/100=10$.

Problem 10 is confirmed/solved by Jaan Bernberg in our Week 8 Discussion Board (http://rpubs.com/jbrnbrg/DiscussWk8_605). 

Additionally, in researching this problem, I came across a note that lifetime of lightbulbs is not necessarily an independent event as there are factors that will influence multiple lightbulbs (such as spikes in the electric grid). 
